...
pub fn getFeaturesNum(feat: *const af.Features) !i64 {
...
pub fn getFeaturesYPos(allocator: std.mem.Allocator, feat: *const af.Features) !*af.Array {
    var arr: af.af_array = undefined;
    try af.AF_CHECK(
...
pub fn getFeaturesScore(allocator: std.mem.Allocator, feat: *const af.Features) !*af.Array {
    var arr: af.af_array = undefined;
...
pub fn getFeaturesOrientation(allocator: std.mem.Allocator, feat: *const af.Features) !*af.Array {
    var arr: af.af_array = undefined;
...
pub fn getFeaturesSize(allocator: std.mem.Allocator, feat: *const af.Features) !*af.Array {
    var arr: af.af_array = undefined;
...
pub fn releaseFeatures(feat: *af.Features) !void {
